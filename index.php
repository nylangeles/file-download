<?php
    ...
    class Git {
        ...
        public function createPullRequest($main = 'main', $remote)
        {
            $ch = curl_init();
            ...
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
            curl_setopt($ch, CURLOPT_POST, 1);
            curl_setopt($ch, CURLOPT_POSTFIELDS, "{\"title\":\"Amazing new feature\",\"body\":\"Please pull these awesome changes in!\",\"head\":\"$main\",\"base\":\"$remote\"}");
    ...
    // $output = $git->syncForkBranch('test-new');
